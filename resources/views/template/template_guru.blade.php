  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <li class="nav-item sidebar-category">
        ...
        <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard_guru_waliKelas') }}">
          <img src="\images/logo-sd-2.svg" alt="logo" />
        </a>
      </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{route('dashboard_guru_waliKelas')}}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{route('isi-nilai')}}">
